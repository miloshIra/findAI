...
def generate_password():
    ...
    password = ''.join(random.choice(letters) for letter in range(12))
    return password
...
def send_password_reset_mail(email, password):
    ...
    :type user_id: string
    :param password: the new generated password
    ...
    send_template_message(subject='Password reset from Ariron.ai',
